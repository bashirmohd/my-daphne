...
#                                                                                                                           #
# e.g python netpreflight_ssh_traceroute.py -H 67.205.158.239 -F /root/largefiles/ -I 5                                     #
# e.g python netpreflight_ssh_traceroute.py -H 138.68.10.107 -F /root/largefiles/ -I 5                                      #                                                        #
# on HOST_B: No action is required on host_B                                                                                #
#                                                                                                                           #
#                                                                                                                           #
# For example:                                                                                                              # 
# python netpremain_keys.py -H 192.5.87.20 -K /Users/bashirm/Downloads/uc-mc4n-key.pem -F /home/cc/experiments/5MB.zip -I 5 #
