...
def loopingFiveMin():
	...
	db = firestore.Client()
	tmpstring='chic--kans--'+str(nowtimestamp)
	...
	db = firestore.Client()
	tmpstring='chic--nash--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='chic--star--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='chic--wash--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='denv--kans--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='DENV--LSVN--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='denv--nrel--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='denv--pnwg--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='denv--sacr--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='elpa--hous--'+str(nowtimestamp)
	print("saving to firestore")
