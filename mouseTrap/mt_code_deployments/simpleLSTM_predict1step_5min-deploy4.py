...
def loopingFiveMin():
	...
	db = firestore.Client()
	tmpstring='elpa--sunn--'+str(nowtimestamp)
	...
	db = firestore.Client()
	tmpstring='eqx-ash--eqx-chi--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='eqx-ash--wash--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='fnal--star--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='hous--kans--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='HOUS--NASH--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='hous--pantex--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='jgi--sacr--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='llnl--sunn--'+str(nowtimestamp)
	print("saving to firestore")
	#pv=pv.item()
	print(pv)
	...
	db = firestore.Client()
	tmpstring='lond--newy--'+str(nowtimestamp)
	print("saving to firestore")
