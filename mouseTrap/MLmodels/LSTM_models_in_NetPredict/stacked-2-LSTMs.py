...
def main():
	df_aofa_lond = pd.read_csv('oneyear/lon_new_out.csv', header=None)
	...
	hist=model.fit(X_train_linkdata, Y_train_linkdata, epochs=20, batch_size=batch_size, shuffle=False, validation_data = (X_val_linkdata, Y_val_linkdata), verbose = 0, callbacks=[time_callback])
