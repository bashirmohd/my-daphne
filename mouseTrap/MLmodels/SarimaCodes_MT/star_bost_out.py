...
path_to_data = 'https://raw.githubusercontent.com/esnet/daphne/master/Multivariate-TimeSeries/Conext/link_csvs/star_bost_out.csv?token=AKKJU5QLFGT4GJOR7ZS3OQS5CMIHO'
...
y_forecasted=pd.DataFrame(y_forecasted, columns = ['L16-bandwidth'])
