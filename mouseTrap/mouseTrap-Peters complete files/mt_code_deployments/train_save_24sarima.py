...
def main():
    ...
    #print(link_train_dataframe)#last 3 months only [-2160:,0]

    #hourly_link=link_train_dataframe.iloc[-50:,0]
    #print(hourly_link)
    ...
    for ec in edgeCalendar1:
        ...
        print(realtraffic)
        #new_row=pd.DataFrame(hourly_link)
        #new_row1=pd.DataFrame({0},index=[1])
        #new_row.append(realtraffic)
        ...
        #print(ec.timestamps)
        #print(ts)
        #print((timedelta(hours=1)).timestamp())
    ...
    for m in all_predictions:
        ...
        #timestringtime=str(m.timestamp[0][0])
        #new_ep=edge_totals(m.name,m.src,m.dest,listtimes,listmeans)
        #new_ep.add_timestamps(listtimes)
        #new_ep.add_values(listmeans)
        #prediction_json_file.append(new_ep)
        print("check")
        #print(len(new_ep.timestamps))
        #print(new_ep.timestamps)

        #print(m.timestamp[0][0])
