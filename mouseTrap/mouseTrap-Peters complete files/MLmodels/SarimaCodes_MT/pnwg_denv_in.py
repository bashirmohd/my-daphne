...
path_to_data = 'https://raw.githubusercontent.com/esnet/daphne/master/Multivariate-TimeSeries/Conext/link_csvs/bost_amst_in.csv?token=AKKJU5SHLGP2ZYRELBTIK7K5DKSM2'
...
ax = average_daily_speed['2018':].plot(label='observed')
pred_dynamic.predicted_mean.plot(label='24hr prediction', ax=ax)
...
y_forecasted=pd.DataFrame(y_forecasted, columns = ['L11-bandwidth'])
