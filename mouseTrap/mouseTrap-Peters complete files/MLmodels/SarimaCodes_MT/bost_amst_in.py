...
path_to_data = 'https://raw.githubusercontent.com/esnet/daphne/master/Multivariate-TimeSeries/Conext/link_csvs/bost_amst_in.csv?token=AKKJU5WBWJI66AIEXNVJGNC5COKZM'
...
plt.title('bost_amst bandwidth  Over Time In Hours')
...
y_forecasted=pd.DataFrame(y_forecasted, columns = ['L27-bandwidth'])
