...
path_to_data = 'https://raw.githubusercontent.com/esnet/daphne/master/Multivariate-TimeSeries/Conext/link_csvs/star_bost_in.csv?token=AKKJU5QRWXGSZGYAR4ETLDC5CMGLG'
...
y_forecasted=pd.DataFrame(y_forecasted, columns = ['L15-bandwidth'])
